    ...
    <section className="section section--tight" id="story">
      <div className="container story">
        <Reveal kind="slide-left" className="story__media cursor-glow">
          <img src="/assets/story/interior-counter-02.jpg" alt="The Waffle House counter and cozy interior seating in Shivmandir, Siliguri" loading="lazy" width={600} height={750} />
        </Reveal>
